...
from the same date the mean is calculated. So labvalues could be after index. 
...
The 6 mo pre and post index are restricted to be within +/- 3 mo. 
...
Only patients with measurements on NT-proBNP before and at index are included. 
