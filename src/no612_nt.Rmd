...
trendfunc3 <- function(data3, tabname) {
  ...
  trend <- rbind(trend, trendfunc2(data2 = data3 %>% filter(shf_age_cat == ">=75"), popname = ">=75y"))
  trend <- rbind(trend, trendfunc2(data2 = data3 %>% filter(shf_location == "In-patient"), popname = "In-patient"))
  trend <- rbind(trend, trendfunc2(data2 = data3 %>% filter(shf_location == "Out-patient"), popname = "Out-patient"))
  ...
  write.xlsx(trend, paste0("./output/tabs/NT-proBNP testing per patient within 6 mo, 1 year and 2 years after the index date - ", 
