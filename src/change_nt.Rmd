...
changefunc2 <- function(data2, changevar2, tabname, tabnamexlsx) {
  ...
  write.xlsx(change, paste0("./output/tabs/", str_remove_all(tabname, fixed("+/-")), 
                            "_", Sys.Date(), ".xlsx"), rowNames = FALSE, overwrite = TRUE)
...
changefunckont <- function(data, tabname) {
  ...
  write.xlsx(both, paste0(
    "./output/tabs/Change in NT-proBNP from prior (3 months to 3 days prior to index) to post (1 day to 3 months post index) - ", tabname, "_", Sys.Date(), ".xlsx"
  ),
