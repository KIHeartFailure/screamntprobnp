...
trendfunc2 <- function(data2, popname) {
  ...
  trend <- rbind(trend, trendfunc(-14, 14, "14 days prior-14 days post index", data2))
  ...
  write.xlsx(trend, 
    paste0("./output/tabs/NT-proBNP testing within 14, 30, 60 and 90 days before and after the index date - ", 
           popname, "_",Sys.Date(), ".xlsx"), rowNames = FALSE, overwrite = TRUE)
